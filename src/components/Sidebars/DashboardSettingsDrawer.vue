<template><!-- Settings Drawer -->
	<a-drawer class="settings-drawer" :class="[rtl ? 'settings-drawer-rtl' : '']" :placement="rtl ? 'left' : 'right'"
		...
		<div class="drawer-content">
			...
			<div class="sharing">
				<h6>Thank you for Boarding On!</h6>
				<div class="share-links">
					...
					<a-button type="dark" target="_blank" href="https://developers.google.com/maps?hl=es-419" size="small">
					...
					<router-link to="/logout" class="btn-sign-in" @click="logout()">	
						<a-button type="dark" target="_blank" href="https://developers.google.com/maps?hl=es-419" size="small">
							Log out
						</a-button>
					</router-link>
